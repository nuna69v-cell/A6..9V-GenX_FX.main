...
def test_production_settings_defaults_insecure():
    """Test that ProductionSettings raises ValidationError when initialized with default values."""
...
def test_production_settings_exness_login_insecure():
    """Test that ProductionSettings raises ValidationError when EXNESS_LOGIN is default."""
    env_vars = {
        "SECRET_KEY": "secure_secret_key",
...
def test_production_settings_exness_password_insecure():
    """Test that ProductionSettings raises ValidationError when EXNESS_PASSWORD is default."""
    env_vars = {
        "SECRET_KEY": "secure_secret_key",
        "EXNESS_LOGIN": "secure_login_123",
