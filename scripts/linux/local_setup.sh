...
# Local Container Setup Script for GenX-FX Trading Platform
# This script sets up containers locally without Docker Hub authentication
...
echo -e "${GREEN}🚀 Setting up GenX-FX Trading Platform (Local Containers)${NC}"
...
# Create simplified Docker Compose configuration
...
cat > local_deployment_info.txt << EOF
GenX-FX Trading Platform Local Deployment
=========================================
...
- Update containers: docker-compose -f docker-compose.local.yml pull && docker-compose -f docker-compose.local.yml up -d
...
echo -e "${GREEN}✅ Local container setup complete!${NC}"
echo -e "${GREEN}📝 Deployment information saved to local_deployment_info.txt${NC}"
