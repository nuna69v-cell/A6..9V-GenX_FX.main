...
# Uses virtual environment and works in current environment
...
echo -e "${GREEN}📝 Deployment information saved to final_deployment_info.txt${NC}"
echo -e "${BLUE}🗄️  Database created: genxdb_fx.db${NC}"
echo -e "${BLUE}🐍 Virtual environment: genx_env/${NC}"
