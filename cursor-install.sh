...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.03.11-6dfa30c-$(date +%s)"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2026.03.11-6dfa30c"
...
ln -s ~/.local/share/cursor-agent/versions/2026.03.11-6dfa30c/cursor-agent ~/.local/bin/agent
ln -s ~/.local/share/cursor-agent/versions/2026.03.11-6dfa30c/cursor-agent ~/.local/bin/cursor-agent
